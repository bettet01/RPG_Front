...
function SignUp() {
    return (
        ...
        <Form.Group id="form-group-username">
            <Form.Label id="label">
            Username</Form.Label>
            <Form.Control id="form-control-username" type="username" placeholder="Username" />
          ...
          <Form.Group id="form-group-password">
            <Form.Label id="label">
            Password</Form.Label>
            <Form.Control id="form-control-password" type="password" placeholder="Password" />
          ...
          <Form.Group id="form-group-password">
            ...
            <Form.Control id="form-control-password" type="password" placeholder="Confirm Password" />
